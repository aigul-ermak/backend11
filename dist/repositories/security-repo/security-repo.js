...
class SecurityRepo {
    ...
    static deleteSpecifiedDeviceToken(userId, deviceId) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield db_1.sessionCollection.deleteMany({ userId: userId, deviceId: { $ne: deviceId } });
            return result.deletedCount > 0;
        });
    }
    static insertRequestFromUser(requestUser) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield db_1.requestCollection.insertOne(requestUser);
            return result;
        });
    }
    static countRequests(ip, url, fromDate) {
        return __awaiter(this, void 0, void 0, function* () {
            const count = yield db_1.requestCollection.countDocuments({
                ip,
                url,
                date: { $gte: fromDate }
            });
