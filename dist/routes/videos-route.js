...
exports.videosRoute.delete('/testing/all-data', (reg, res) => {
    db_1.db.videos.splice(0, db_1.db.videos.length);
    return res.sendStatus(204);
});
exports.videosRoute.get('/videos', (req, res) => {
...
exports.videosRoute.post('/videos', (req, res) => {
    let error = {
        errorsMessages: []
    };
...
exports.videosRoute.put('/videos/:id', (req, res) => {
    const id = +req.params.id;
    let error = {
        errorsMessages: []
    };
...
exports.videosRoute.delete('/videos/:id', (req, res) => {
    const id = +req.params.id;
    let error = {
        errorsMessages: []
    };
